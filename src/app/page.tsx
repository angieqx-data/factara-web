...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 pb-24 pt-10 sm:px-10">
        <header className="flex items-center justify-between">
          <Link href="/" className="text-lg font-semibold text-white">
            Factara
          </Link>
          <nav aria-label="Primary" className="flex items-center gap-6 text-sm font-medium text-white/70">
        ...
        <main className="mt-16 flex flex-col gap-24">
          <section className="flex flex-col items-center gap-8 text-center">
            ...
            <p className="max-w-3xl text-lg text-white/70 sm:text-xl">
              The world is drowning in information, yet starving for <em className="text-white">verified understanding</em>.
              Factara quantifies factual accuracy, bias, and source reliability so your audience never has to guess what—or
              who—to believe.
            </p>
          ...
          <section id="platform" className="grid gap-8 md:grid-cols-3">
            {pillars.map(pillar => (
              <article
                key={pillar.title}
          ...
          <section id="signals" className="grid items-start gap-12 lg:grid-cols-[1.2fr_1fr]">
            <div>
              <h2 className="text-3xl font-semibold text-white sm:text-4xl">What we measure</h2>
              <p className="mt-4 max-w-2xl text-base text-white/70 sm:text-lg">
                Factara doesn&apos;t stop at binary fact-checks. We compute a multidimensional credibility graph—tracking how
                claims evolve, which narratives amplify them, and which sources you can trust when speed matters.
              </p>
            ...
            <div className="rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/20 via-emerald-500/10 to-transparent p-8 text-sm text-white/80 shadow-lg">
              ...
              <p className="mt-4 leading-relaxed">
                The core disease isn&apos;t lack of data; it&apos;s the erosion of <em>epistemic trust</em>. Factara addresses that
                disease directly with transparent methodologies, auditable trails, and governance tooling that stands up in
                politically charged environments.
              </p>
              <p className="mt-4 leading-relaxed">
                With Factara, teams can counter information warfare, accelerate due diligence, and rebuild the compact between
                institutions and the public.
              </p>
            </div>
          </section>

          <section id="audiences" className="rounded-3xl border border-white/10 bg-slate-900/70 p-10">
            ...
            <p className="mt-3 max-w-3xl text-base text-white/70 sm:text-lg">
              Credibility is a network effect. Factara gives every stakeholder a synchronized, transparent view of reality—so
              collaboration replaces confusion.
            </p>
          ...
          <section className="rounded-3xl border border-emerald-500/40 bg-gradient-to-br from-emerald-500/20 via-emerald-500/10 to-transparent p-10 text-center">
            ...
            <p className="mt-4 text-base text-white/70 sm:text-lg">
              Partner with Factara to turn overwhelming information flows into defensible intelligence. In an age of synthetic
              content, credibility isn&apos;t optional—it&apos;s infrastructure.
            </p>
